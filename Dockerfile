...
RUN echo "alias python='python3'" >> $HOME/.bash_aliases \
    ...
    && echo "alias bitcoind='/workspace/bin/bitcoin-0.18.0/bin/bitcoind -datadir=${BITCOIN_REGTEST}'" >> $HOME/.bash_aliases  \
    && echo "alias bitcoin-cli='/workspace/bin/bitcoin-0.18.0/bin/bitcoin-cli -datadir=${BITCOIN_REGTEST}'" >> $HOME/.bash_aliases
